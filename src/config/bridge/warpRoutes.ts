...
export const warpRouteConfigs: WarpCoreConfig = {
  tokens: [
    ...
    // BSC DAI + ETH opened 2026-09-08 (kalychain-ops bridge/bsc-routes.sh): both routers
    // enroll 3890, both 3890 synthetics enroll 56, 18 decimals on both sides, and each
    // chain has a 1-of-1 multisig ISM for the other's validator.
    // Polygon USDC/DAI/ETH/WBTC opened 2026-09-08 the same way (bridge/polygon-routes.sh).
    {
